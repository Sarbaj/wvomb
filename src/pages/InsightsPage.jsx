    ...
    <div className="min-h-screen bg-white pt-32">
        ...
        <div className="max-w-[1600px] mx-auto px-6 lg:px-12">
          ...
          >
            <h1 className="text-6xl lg:text-8xl tracking-tight mb-8 leading-[0.9]">
              Case Studies <br />
              <span className="text-[#8A8A8A]">&</span> Insights
            </h1>
      ...
      <section className="py-24 lg:py-32">
        <div className="max-w-[1600px] mx-auto px-6 lg:px-12">
          ...
          >
            More <span className="text-[#8A8A8A]">Stories</span>
          </motion.h2>
                ...
                <FloatingCard className="group cursor-pointer">
                  <div className="grid md:grid-cols-2 gap-8 items-center">
                    ...
                    <div>
                      ...
                      <button className="inline-flex items-center gap-2 text-black hover:gap-3 transition-all group">
      ...
      <section className="py-24 lg:py-32 bg-black text-white">
        <div className="max-w-[1600px] mx-auto px-6 lg:px-12 text-center">
          <h2 className="text-5xl lg:text-6xl mb-6">
            Impact by <span className="text-[#8A8A8A]">Numbers</span>
          </h2>
      ...
      <section className="py-24 lg:py-32 bg-[#D9D9D9] text-center">
        <h2 className="text-5xl lg:text-7xl mb-8">
          ...
          <span className="text-[#8A8A8A]">Success Story?</span>
        </h2>
