    ...
    <div className="min-h-screen bg-white pt-32">
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              <h1 className="text-6xl lg:text-8xl tracking-tight mb-8 leading-[0.9]">
                Building the
                <br />
                <span className="text-[#8A8A8A]">Future of</span>
                <br />
                Finance
              </h1>
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-start">
            ...
            >
              <h2 className="text-5xl lg:text-6xl tracking-tight mb-8">
                Our <span className="text-[#8A8A8A]">Story</span>
              </h2>

              <div className="space-y-6 text-xl text-[#8A8A8A] leading-relaxed">
                <p>
      ...
      <section className="py-24 lg:py-32">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          ...
          >
            Our <span className="text-[#8A8A8A]">Journey</span>
          </motion.h2>
              ...
              >
                <FloatingCard>
                  <div className="flex items-start gap-8">
                    <div className="text-6xl tracking-tight text-[#D9D9D9] min-w-[120px]">
                      {item.year}
                    </div>
      ...
      <section className="py-24 lg:py-32 bg-black text-white">
        <div className="max-w-[1600px] mx-auto px-6 lg:px-12">
          ...
          >
            Our <span className="text-[#8A8A8A]">Values</span>
          </motion.h2>
